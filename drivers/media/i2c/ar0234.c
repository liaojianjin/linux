	{ 0x302A, 0x0005 }, { 0x302C, 0x0001 }, { 0x302E, 0x0003 },
	{ 0x3030, 0x0032 }, { 0x3036, 0x000A }, { 0x3038, 0x0001 },
	{ 0x30B0, 0x0028 }, { 0x31B0, 0x0082 }, { 0x31B2, 0x005C },
	{ 0x31B4, 0x5248 }, { 0x31B6, 0x3257 }, { 0x31B8, 0x904B },
	{ 0x31BA, 0x030B }, { 0x31BC, 0x8E09 }, { 0x3354, 0x002B },
	{ 0x31D0, 0x0000 }, { 0x31AE, 0x0204 }, { 0x3002, 0x00D0 },
	{ 0x3004, 0x0148 }, { 0x3006, 0x048F }, { 0x3008, 0x0647 },
	{ 0x3064, 0x1802 }, { 0x300A, 0x04C4 }, { 0x300C, 0x04C4 },
	{ 0x30A2, 0x0001 }, { 0x30A6, 0x0001 }, { 0x3012, 0x010C },
	{ 0x3786, 0x0006 }, { 0x31AE, 0x0202 }, { 0x3088, 0x8050 },
	{ 0x3086, 0x9237 }, { 0x3044, 0x0410 }, { 0x3094, 0x03D4 },
	{ 0x3096, 0x0280 }, { 0x30BA, 0x7606 }, { 0x30B0, 0x0028 },
	{ 0x30BA, 0x7600 }, { 0x30FE, 0x002A }, { 0x31DE, 0x0410 },
	{ 0x3ED6, 0x1435 }, { 0x3ED8, 0x9865 }, { 0x3EDA, 0x7698 },
	{ 0x3EDC, 0x99FF }, { 0x3EE2, 0xBB88 }, { 0x3EE4, 0x8836 },
	{ 0x3EF0, 0x1CF0 }, { 0x3EF2, 0x0000 }, { 0x3EF8, 0x6166 },
	{ 0x3EFA, 0x3333 }, { 0x3EFC, 0x6634 }, { 0x3088, 0x81BA },
	{ 0x3086, 0x3D02 }, { 0x3276, 0x05DC }, { 0x3F00, 0x9D05 },
	{ 0x3ED2, 0xFA86 }, { 0x3EEE, 0xA4FE }, { 0x3ECC, 0x6E42 },
	{ 0x3ECC, 0x0E42 }, { 0x3EEC, 0x0C0C }, { 0x3EE8, 0xAAE4 },
	{ 0x3EE6, 0x3363 }, { 0x3EE6, 0x3363 }, { 0x3EE8, 0xAAE4 },
	{ 0x3EE8, 0xAAE4 }, { 0x3180, 0xC24F }, { 0x3102, 0x5000 },
	{ 0x3060, 0x000D }, { 0x3ED0, 0xFF44 }, { 0x3ED2, 0xAA86 },
	{ 0x3ED4, 0x031F }, { 0x3EEE, 0xA4AA },
};
...
static int ar0234_read_reg(struct ar0234 *ar0234, u16 reg, u16 len, u32 *val)
{
	...
	if (len > 4) {
		dev_err(&client->dev,
			"%s: invalid length %d. i2c read register failed\n",
			__func__, len);
		return -EINVAL;
	}
	...
	if (ret != ARRAY_SIZE(msgs)) {
		dev_err(&client->dev,
			"%s: i2c read register 0x%x from 0x%x failed\n",
...
static int ar0234_write_reg(struct ar0234 *ar0234, u16 reg, u16 len, u32 val)
{
	...
	if (len > 4) {
		dev_err(&client->dev,
			"%s: invalid length %d. i2c write register failed\n",
			__func__, len);
		return -EINVAL;
	}
	...
	if (i2c_master_send(client, buf, len + 2) != len + 2) {
		dev_err(&client->dev,
			"%s: i2c write register 0x%x from 0x%x failed\n",
			__func__, reg, client->addr);
		return -EIO;
	}
...
static int ar0234_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	if (ctrl->id == V4L2_CID_VBLANK) {
		...
		__v4l2_ctrl_modify_range(
			ar0234->exposure, ar0234->exposure->minimum,
			exposure_max, ar0234->exposure->step,
			ar0234->cur_mode->height - AR0234_EXPOSURE_MAX_MARGIN);
	}
...
static int ar0234_init_controls(struct ar0234 *ar0234)
{
	...
	ar0234->link_freq = v4l2_ctrl_new_int_menu(
		ctrl_hdlr, &ar0234_ctrl_ops, V4L2_CID_LINK_FREQ,
		ARRAY_SIZE(link_freq_menu_items) - 1, 0, link_freq_menu_items);
	if (ar0234->link_freq)
		ar0234->link_freq->flags |= V4L2_CTRL_FLAG_READ_ONLY;

	ar0234->vblank = v4l2_ctrl_new_std(
		ctrl_hdlr, &ar0234_ctrl_ops, V4L2_CID_VBLANK, 0,
...
#endif
	ar0234->strobe_source =
		v4l2_ctrl_new_std_menu(ctrl_hdlr, &ar0234_ctrl_ops,
				       V4L2_CID_FLASH_STROBE_SOURCE, 1, 0, 1);
	...
	ar0234->strobe_stop = v4l2_ctrl_new_std(ctrl_hdlr, &ar0234_ctrl_ops,
						V4L2_CID_FLASH_STROBE_STOP, 0,
						0, 0, 0);
	ar0234->timeout = v4l2_ctrl_new_std(ctrl_hdlr, &ar0234_ctrl_ops,
					    V4L2_CID_FLASH_TIMEOUT, -128, 127,
					    1, 0);
	...
	ar0234->i2c_slave_address = v4l2_ctrl_new_custom(
		ctrl_hdlr, &ar0234_i2c_slave_address, NULL);
	...
	ar0234->frame_interval =
		v4l2_ctrl_new_custom(ctrl_hdlr, &ar0234_frame_interval, NULL);

	ar0234->pixel_rate = v4l2_ctrl_new_std(ctrl_hdlr, &ar0234_ctrl_ops,
					       V4L2_CID_PIXEL_RATE,
					       get_pixel_rate(ar0234),
					       get_pixel_rate(ar0234), 1,
					       get_pixel_rate(ar0234));
			     ...
			     struct v4l2_subdev_format *fmt)
{
	...
	if (fmt->which == V4L2_SUBDEV_FORMAT_TRY) {
		...
		*v4l2_subdev_get_try_format(sd, sd_state, fmt->pad) =
		...
		hblank = get_hblank(ar0234);
		__v4l2_ctrl_modify_range(ar0234->hblank, hblank, hblank, 1,
					 hblank);
...
#else
		fmt->format = *v4l2_subdev_get_try_format(&ar0234->sd, sd_state,
							  fmt->pad);
#endif
	else
...
static int
ar0234_enum_frame_interval(struct v4l2_subdev *subdev,
#if LINUX_VERSION_CODE < KERNEL_VERSION(5, 14, 0)
			   struct v4l2_subdev_pad_config *cfg,
#else
			   struct v4l2_subdev_state *sd_state,
...
static const struct dev_pm_ops ar0234_pm_ops = { SET_SYSTEM_SLEEP_PM_OPS(
	ar0234_suspend, ar0234_resume) };
...
#ifdef CONFIG_ACPI
static const struct acpi_device_id ar0234_acpi_ids[] = { { "INTC10C0" },
							 { /* sentinel */ } };
